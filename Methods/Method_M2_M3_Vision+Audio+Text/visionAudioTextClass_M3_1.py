...
class visionAudioText2Concat(torch.nn.Module):
    def __init__(
        self,
        num_classes = 5,
        ...
        fusion_output_size=1024,  #512+512+128
        dropout_p = 0.2,
        ):
        
        super(visionAudioText2Concat, self).__init__()
        ...
        self.text_layer = torch.nn.Linear(
                in_features=768,
                out_features=768
        )
    ...
    def forward(self, image, audio, text): #please give us input already embedded vggish
        ...
        combined_avt = torch.cat(
            [audio_features, image_features, text_features], dim=1
        )
...
class visionAudioText2Class():
    def __init__(self, optimizer='sgd', lossfnct='mse', model='inst', learningrate=1e-5, device='cuda'):
        ...
        self.net = visionAudioText2Concat()
        ...
        # checkpointLoader = torch.load('visionAudioText_2/checkpoint/visionAudioText2_parameters_checkpoint.pt')
        ...
        # self.loss_values_train = openFilePkl('visionAudioText_2/lossValuesTrain.pickle')
        # self.loss_values_val = openFilePkl('visionAudioText_2/lossValuesVal.pickle')
        # self.loss_values_test = openFilePkl('visionAudioText_2/lossValuesTest.pickle')
        # self.mse_class_train = openFilePkl('visionAudioText_2/mseClassTrain.pickle')
        # self.mse_class_val = openFilePkl('visionAudioText_2/mseClassVal.pickle')
        # self.mse_class_test = openFilePkl('visionAudioText_2/mseClassTest.pickle')
        # self.traitAccTrain = openFilePkl('visionAudioText_2/traitAccTrain.pickle')
        # self.meanAvgAccAllTrain = openFilePkl('visionAudioText_2/meanAvgAccAllTrain.pickle')
        # self.traitAccVal = openFilePkl('visionAudioText_2/traitAccVal.pickle')
        # self.meanAvgAccAllVal = openFilePkl('visionAudioText_2/meanAvgAccAllVal.pickle')
                
        # self.traitAccTest = openFilePkl('visionAudioText_2/traitAccTest.pickle')
        # self.meanAvgAccAllTest = openFilePkl('visionAudioText_2/meanAvgAccAllTest.pickle')
    ...
    def train(self, train_dl, epoch):
        ...
        for batch in train_dl:
            ...
            inputAudio, inputImage, inputText, labels = inputAudioVggish.to(self.device), batch['image'].to(self.device), inputTextToken.to(self.device), batch['groundtruth'].float().to(self.device)
        ...
        torch.save({
            ...
            'loss': loss
            }, self.pathRes+'/checkpoint/visionAudioText2_parameters_checkpoint.pt')
