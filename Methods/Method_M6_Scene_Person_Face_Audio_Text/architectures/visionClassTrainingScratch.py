...
from VideoSwinTransformer.mmcv import Config, DictAction
from VideoSwinTransformer.mmaction.models import build_model
from VideoSwinTransformer.mmcv.runner import get_dist_info, init_dist, load_checkpoint
...
class visionVideoSwin(torch.nn.Module):
    def __init__(
        ...
        #config = './Video-Swin-Transformer/configs/recognition/swin/swin_small_patch244_window877_kinetics400_1k.py',
        #checkpoint = './checkpoints/swin_small_patch244_window877_kinetics400_1k.pth',
        # config = './Video-Swin-Transformer/configs/recognition/swin/swin_base_patch244_window877_kinetics400_1k.py',
        ...
        #config = './Video-Swin-Transformer/configs/recognition/swin/swin_base_patch244_window877_kinetics600_22k.py',
