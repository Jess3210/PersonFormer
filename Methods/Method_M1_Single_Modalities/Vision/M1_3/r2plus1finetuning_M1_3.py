...
from architectures.r2plus1d import r2plus1d_34_32_ig65m as r2plus1d_34
...
class visionFinetuningClass():
    def __init__(self, optimizer='sgd', lossfnct='mse', learningrate=1e-5, device='cuda', bs=32):
        ...
        #----load checkpoint if training stopped and want to go on with training from saved checkpoint
        ...
        #send optimizer to GPU - set active during restart of a training with checkpoint
        ...
        #-----uncomment for restart training with saved checkpoints and information -------
    ...
    def optimizer_to(self, optim, device):
        #Code optimizer_to taken from: https://github.com/pytorch/pytorch/issues/8741
