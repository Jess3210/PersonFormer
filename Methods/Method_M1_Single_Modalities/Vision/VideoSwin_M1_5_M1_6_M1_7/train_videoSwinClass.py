...
from videoSwinClass import visionClass #rVideoSwin
import pickle
...
def process(bs=16, epochs=100, lossfunction='mse', learningrate=1e-5, cudadevice='cuda', root_dir_path = './ChaLearn_First_Impression/'):
    ...
    modelProcess = visionClass(optimizer='sgd', lossfnct=lossfunction, learningrate=learningrate, device=cudadevice)
